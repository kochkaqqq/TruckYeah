...
public static class CargoMapper
{
    public static Cargo MapToModel(this CargoEntity cargoEntity)
    {
        return new Cargo
        {
            ...
            RouteDistanceKm = cargoEntity.RouteDistanceKm,
            RouteDurationMinutes = cargoEntity.RouteDurationMinutes,
            RouteFuelLiters = cargoEntity.RouteFuelLiters,
            RouteGeometryGeoJson = cargoEntity.RouteGeometryGeoJson,
            RouteCalculatedAt = cargoEntity.RouteCalculatedAt,
            ...
            UseAutomaticCalculation = cargoEntity.UseAutomaticCalculation,
            WeightPerPackageKg = cargoEntity.WeightPerPackageKg,
