...
public static class TruckMapper
{
    public static Truck MapToModel(this TruckEntity truckEntity)
    {
        return new Truck
        {
            ...
            RoutePoints = truckEntity.RoutePoints.OrderBy(p => p.Order).ToList(),
            RouteDistanceKm = truckEntity.RouteDistanceKm,
            RouteDurationMinutes = truckEntity.RouteDurationMinutes,
            RouteFuelLiters = truckEntity.RouteFuelLiters,
            RouteGeometryGeoJson = truckEntity.RouteGeometryGeoJson,
            RouteCalculatedAt = truckEntity.RouteCalculatedAt,
            ...
            AdditionalEquipment = truckEntity.AdditionalEquipment,
